from nets.unetplus import UnetPlus
...
class uNet(object):
    ...
    #-----------------------------------------#
    _defaults = {
        "model_path"        :   'logs\Epoch100-Total_Loss0.1853-Val_Loss0.2283.pth',
    ...
    def generate(self):
        ...
        self.net = UnetPlus(num_class=self.num_classes)
        ...
        if self.num_classes<= 21:
            self.colors = [ (0, 0, 0), (255, 0, 0), (0, 255, 0), (0, 0, 128), (128, 0, 128), (0, 128, 128), 
